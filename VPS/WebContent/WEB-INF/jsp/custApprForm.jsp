...
<body>
<div class="header">
	<img class="logo" src="image/LCSD WEB LOGO.png" alt="LCSD"  width="377" height="175" />
</div>
<div class="content">
<!-- <p><img class="logo" src="image/lcsd_logo.png" alt="LCSD"  width="538" height="250"/></p> -->
<h4 style="text-align: center;font-size:1.5em;margin-top:0px"><strong>顧客讚賞卡 </strong></h4>
<h5 style="text-align: center;font-size:1.5em;margin-top:-10px"><strong>Customer Appreciation Card</strong></h5>

<p></p>
<form method="post" action="CAC"  onsubmit="validate()" id="CAC">
<h4><strong>你想讚賞的場地 You want to compliment on :</strong></h4>
...
<h4><span id="loc" style="color:#f05828;font-weight:bold;font-size:1.4em"><c:out value="${location}"/></span></h4>

</div>
<p></p>
<p><em>請在適當方格內加上<span>「</span></em>✔<em><span></span></em><em><span>」，並可選多於一項。</span>Please put a "✔" in the appropriate box(es). You may select more than one item.</em></p>

			<div class="checkCat" style="box-sizing: border-box;padding: 5px;margin:5px 5px 5px 5px;font-size:0.9em" >
			<input type="checkbox" name="category" value="Staff" /><strong>員工<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Staff</strong>
			<br/><br/>
			<input type="checkbox" name="category" value="Venue Environent and Facilities" /><strong>場地環境及/或設施<br/> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Venue Environment and/or Facilities</strong>
			<br/><br/>
			<input type="checkbox" name="category" value="Programmes/Events" /><strong>節目及/或活動<br/> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Programmes and/or Events</strong>
			
			</div>

			<input type="button" onclick="openOptionalForm()" value="選填 Optional"style="padding: 2px 8px;border-radius: 5px;margin-left:1em; font-size:0.9em;margin-top:0.7em;margin-bottom:0.7em"/>
			<div id="optional" style="display:none"> 
			<br/><br/>
			
			<p class = "cell">
			讚賞詳情 Compliment Details<br/>
			<textarea rows="5" style="width: 98%;box-sizing: border-box; font-size:1.5em;margin-right:0.5em;" name="feedback" id= "fb" maxlength="400" spellcheck="false"></textarea>
			<br/>
			</p>
			</div>
<br/><br/>
